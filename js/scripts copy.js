...
window.addEventListener('DOMContentLoaded', event => {
    ...
    //When detect a change on any filter button
    /*
    $("#FilterStatus", "#FilterUrgency").change(function () {
        filterByAllFilters();        
    });
    */
...
/*
    //Make all lines above in one line
    $("#FilterStatus, #FilterUrgency, #FilterOwner, #FilterIndex, #FilterByTime").change(function () {
        filterByAllFilters();        
    });
    */
});
...
function filterByAllFilters() {
    ...
    var filter_time = document.getElementById("FilterByTime").value;
    ...
    var query = jQuery.ajax({
        ...
        data: {
            ...
            time1: time1, time2: time2, data1: data1, data2: data2, filter_time: filter_time
        },
        success: function (data) {
            //console.log(data);	
            showAlerts(JSON.parse(data));
